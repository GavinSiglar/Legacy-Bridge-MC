...
public class NbtPatcher {
    ...
    public record PatchResult(int patched, int total, List<String> warnings) {}
    ...
    public static PatchResult patchChunkNbt(NbtCompound chunkNbt) {
        if (chunkNbt == null) return new PatchResult(0, 0, List.of());
    ...
    private static PatchResult patchEntityList(NbtList entities) {
        ...
        return new PatchResult(patchCount, totalCount, warnings);
    }
